(() => {
  ...
  const EXPECTED_CORPUS_SHA256 = "d19f013f9c480c5b1766f8e3566682958d47a80f6af48aacc73d592d25ca3413";
  const EXPECTED_SOURCE_MANIFEST_SHA256 = "32231e39c1178bb219923e00dff56d6139dfec0bf25690e7f21172243cc590a9";
  ...
  async function serviceWorkerStatus(Engine) {
    ...
    try {
      const registration = await navigator.serviceWorker.register("/public-twin/sw.js", {
        scope: "/public-twin/",
        updateViaCache: "none",
      });
      ...
      navigator.serviceWorker.addEventListener("controllerchange", async () => {
        ...
        updateRuntimeStatus();
        if (runtime.offlineReady) {
          setLive("Offline shell control and cached corpus integrity are verified for /public-twin/.");
        } else if (runtime.serviceWorkerControlled) {
