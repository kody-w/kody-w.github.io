...
This is the same pattern as [running real speciation on a laptop]({% post_url 2025-09-19-real-speciation-on-a-laptop %}) and the [Theory of Mind sim]({% post_url 2026-04-18-evolving-a-mind-in-500-lines-of-python %}):
