...
In a multi-agent system, the context window is the only truly scarce resource. Computing cycles are cheap and memory is infinite, but the attention of the next executing node is a strict bottleneck.
